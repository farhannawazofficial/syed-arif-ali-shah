...
import { Img1, Weather_App, CRUD_App, Portfolio } from "../assets/images/index.js"
...
function Projects() {
  ...
  const projects = [
    {
      id: 1,
      image: Img1,
      imageAlt: "THD INSTITUTE Seminars",
      name: "THD INSTITUTE Seminars",
      description: "Express & Empower: Share Your Thoughts Securely with THD Institute Seminars.",
      links: {
        facebook: "https://github.com/talhashah-dev/blogging-app",
  ...
  return (
    <div className="pb-5 h-auto my-20" id="projects">
      ...
      <h1 className="text-6xl max-md:text-4xl font-bold mb-10">Seminars</h1>
